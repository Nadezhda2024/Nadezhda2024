...
|Проект 6 Конкурс (__[github](https://github.com/Nadezhda2024/participation-in-the-competition-Fastboard)__) | Задание конкурса: проанализировать данные, создать понятный и красивый дашборд на свой вкус, используя конструктор дашбордов.|BI система FastBoard, ClickHouse|
