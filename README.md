...
### Мои достижения
:3rd_place_medal: Решение призового кейса: Заняла **3 место** в конкурсе Fastboard (ноябрь 2025) от компании разработчика Win Solutions (__[github](https://github.com/Nadezhda2024/Nadezhda2024/blob/main/photo_2025-11-27_19-09-38.jpg)__)
...
|Проект 6 Конкурс (__[github](https://github.com/Nadezhda2024/participation-in-the-competition-Fastboard)__) | Задание конкурса: проанализировать данные, создать понятный и красивый дашборд на свой вкус, используя конструктор дашбордов.|BI система FastBoard, ClickHouse, Figma|
|Проект 7 Стажировка (__[github](https://github.com/Nadezhda2024/participation-in-the-competition-Fastboard)__) | В составе кросс-функциональной команды (Project Manager, Business Analyst, BI-аналитик), мы провели Discovery компании, выявили ключевые бизнес-проблемы и предложили решение в формате дашбордов. Ответственна за прототипирование дашбордов: определяла метрики, согласовывала их с командой и создавала финальные прототипы на этапе Delivery.|Miro|
